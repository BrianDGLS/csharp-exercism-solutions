...
public class SayTests
{
    ...
    [Fact]
    public void Forty_seven()
    {
        Assert.Equal("forty-seven", Say.InEnglish(47L));
    }

    [Fact]
    public void Eighty_one()
    {
        Assert.Equal("eighty-one", Say.InEnglish(81L));
    }
    ...
    [Fact]
    public void Seven_hundred_one()
    {
        Assert.Equal("seven hundred one", Say.InEnglish(701L));
    }
    ...
    [Fact]
    public void Forty_five_thousand_two_hundred_thirty_four()
    {
        Assert.Equal("forty-five thousand two hundred thirty-four", Say.InEnglish(45234L));
    }
